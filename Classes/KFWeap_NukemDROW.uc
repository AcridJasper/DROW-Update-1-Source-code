class KFWeap_NukemDROW extends KFWeapon;
...
defaultproperties
{
	...
	InventorySize=7
	WeaponSelectTexture=Texture2D'WEP_NukemDROW_MAT.UI_WeaponSelect_NukemDROW_CS'
	...
	// Content
	PackageKey="NukemDROW"
	FirstPersonMeshName="WEP_NukemDROW_MESH.Wep_1stP_NukemDROW_CS_Rig"
	FirstPersonAnimSetNames(0)="WEP_1P_SeekerSix_ANIM.Wep_1stP_SeekerSix_Anim"
	PickupMeshName="WEP_NukemDROW_MESH.Wep_NukemDROW_CS_Pickup"
	AttachmentArchetypeName="WEP_NukemDROW_ARCH.Wep_NukemDROW_CS_3P"
	MuzzleFlashTemplateName="WEP_SeekerSix_ARCH.Wep_SeekerSix_MuzzleFlash"

	// Ammo
	MagazineCapacity[0]=1
	SpareAmmoCapacity[0]=7 //9
	InitialSpareMags[0]=1
	AmmoPickupScale[0]=2.0
	bCanBeReloaded=true
	bReloadFromMagazine=true
	ForceReloadTime=0.6 //0.3
	...
	// DEFAULT_FIREMODE (Explosive rocket that nukes)
	...
	WeaponProjectiles(DEFAULT_FIREMODE)=class'KFProj_Rocket_NukemDROW'
	InstantHitDamageTypes(DEFAULT_FIREMODE)=class'KFDT_Ballistic_NukemDROW'
	FireInterval(DEFAULT_FIREMODE)=+0.75 //+0.65
	InstantHitDamage(DEFAULT_FIREMODE)=200 //155
    PenetrationPower(DEFAULT_FIREMODE)=0
	Spread(DEFAULT_FIREMODE)=0.025
	FireOffset=(X=20,Y=4.0,Z=-3)

    SelfDamageReductionValue=0.10f //0.08f; //26
