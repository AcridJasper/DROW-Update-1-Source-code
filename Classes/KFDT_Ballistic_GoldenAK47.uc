class KFDT_Ballistic_GoldenAK47 extends KFDT_Ballistic_AssaultRifle
	abstract
	hidedropdown;

/** Has to still to play a metal effect if impacting metal. (and we demoted to impact on Flesh) */
...
defaultproperties
{
	...
	WeaponDef=class'KFWeapDef_GoldenAK47'
